                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <div class="d-flex justify-content-start">
                                              <form action="{{ route('categorias.edit', ['categoria' => $marca]) }}"
                                                  method="get">
                                      ...
                                      <div class="modal-dialog">
                                          <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                  {{ $marca->caracteristica->estado == 1 ? '¿Desea desactivar la categoria?' : '¿Desea restaurar la categoria?' }}
                                              </div>
                                              <div class="modal-footer">
                                                  <button type="button" class="btn btn-danger"
                                                      data-bs-dismiss="modal">Cancelar</button>
                                                  <form
                                                      action="{{ route('categorias.destroy', ['categoria' => $marca->id]) }}"
                                                      method="post">
                                                      @method('DELETE')
                                                      @csrf
